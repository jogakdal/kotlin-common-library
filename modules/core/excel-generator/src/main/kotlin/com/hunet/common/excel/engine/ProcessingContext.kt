...
import com.hunet.common.excel.DocumentMetadata
import com.hunet.common.excel.ExcelDataProvider
import com.hunet.common.excel.ExcelGeneratorConfig
import com.hunet.common.excel.PivotTableProcessor

/**
 * Excel 처리 파이프라인의 컨텍스트.
 *
 * 템플릿 처리 과정에서 필요한 모든 정보와 중간 상태를 보관합니다.
 * 각 프로세서는 이 컨텍스트를 통해 데이터를 교환합니다.
 *
...
internal class ProcessingContext(
     ...
     * ChartExtractProcessor가 설정하고 ChartRestoreProcessor가 사용합니다.
     */
    ...
    /**
     * 추출된 피벗 테이블 정보 목록.
     * PivotExtractProcessor가 설정하고 PivotRecreateProcessor가 사용합니다.
     */
